...
public class ProductoController {
    ...
    @PostMapping
    public String guardar(@Valid @ModelAttribute("producto") Producto prod,
        ...
        flash.addFlashAttribute("ok", "Producto registrado exitosamente");
    ...
    public String actualizar(@PathVariable Long id,
                             @Valid @ModelAttribute("producto") Producto prod,
                             BindingResult errores,
                             RedirectAttributes flash) {
        if (errores.hasErrors()) {
            return "productos/form";
        ...
        prod.setId(id);
        productoService.guardar(prod);
        flash.addFlashAttribute("ok", "Producto actualizado correctamente");
        return "redirect:/productos";
    }
    ...
    public String eliminar(@PathVariable Long id, RedirectAttributes flash) {
        ...
        flash.addFlashAttribute("ok", "Producto eliminado del sistema");
        return "redirect:/productos";
    }
}
